<%@page import="Student.entity.teacher"%>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-2">
					<div class="list-group">
					  ...
					  <a href="${pageContext.request.contextPath}/teacher?method=getteacherAdd" class="list-group-item ">教师添加</a>
					</div>
				</div>
				<!--左边部分 end-->
				<!--右边部分 Benin-->
			<div class="col-md-10">
					  ...
					  <div class="form-group">
					    ...
					    <input type="text" name="name" value="<%=teacher.getName()%>" class="form-control" >
					  </div>
					  <div class="form-group">
					    <label for="exampleInputPassword1">年龄</label>
					    <input type="text" name="age" value="<%=teacher.getAge()%>" class="form-control" >
					  </div>
					    <div class="form-group">
					    <label for="exampleInputPassword1">性别</label>
					    <input type="text" name="gender" value="<%=teacher.getGender()%>" class="form-control" >
					  </div>
					    <div class="form-group">
