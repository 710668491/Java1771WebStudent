...
$(function(){
	$("#nameId").blur(function(){
		var name = $(this).val();
		$.post(
				"${ctx}/banji?method=checkName",//url
				{"name":name}, //data
			...
			<div class="row">
				...
				<div class="col-md-2">
					<div class="list-group">
					  <a href="${ctx}/banji?method=findbanji" class="list-group-item  ">班级列表</a>
					  <a href="${ctx}/banji?method=getbanjiAdd" class="list-group-item active">班级添加</a>
					</div>
				</div>
				<!--左边部分 end-->
				<!--右边部分 Benin-->
			<div class="col-md-10">
				 <form action="${pageContext.request.contextPath}/banji?method=addbanji" method="post">
				
					  <div class="form-group">
					    <label for="exampleInputPassword1">班级</label>
					    <input type="text" id="nameId" name="name" class="form-control" id="exampleInputPassword1" >
