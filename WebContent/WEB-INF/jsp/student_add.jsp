	...
	<body>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-2">
					<div class="list-group">
					  ...
					  <a href="${pageContext.request.contextPath}/student?method=getStduentAdd" class="list-group-item active">学生添加</a>
					</div>
				</div>
				<!--左边部分 end-->
				<!--右边部分 Benin-->
			<div class="col-md-10">
				      ...
				      <form action="${pageContext.request.contextPath}/student?method=addstudnet" method="post">
					  <div class="form-group">
					    <label for="exampleInputEmail1">姓名</label>
					    <input type="text" id="nameId" name="name" class="form-control" id="exampleInputEmail1" placeholder="name">
